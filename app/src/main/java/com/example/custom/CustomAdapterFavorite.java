...
public class CustomAdapterFavorite extends ArrayAdapter<Song> {
    private TextView textView5, textView8;
    private ImageView imageView5;

    public CustomAdapterFavorite(@NonNull Context context, int resource, @NonNull List<Song> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (view != null) {
            if (MainActivity.list_song.get(position).getCheckFavorite() == 1) {
